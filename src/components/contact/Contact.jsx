...
const Contact = () => {
  const form = useRef();
    ...
    emailjs.sendForm('service_vw578mm', 'template_flbk75e', form.current, 'ngb1Eo4TigILlBMZb')
      .then((result) => {
      ...
      <div className="container contact_container">
        <div className="contact_options">
          <article className='contact_option'>
            ...
            <h4>Email</h4>
            <h5>haravindreddyrajula@gmail.com</h5>
            <a href='mailto:haravindreddyrajula@gmail.com' target="_blank" rel="noreferrer">Send a message</a>
          </article>
            <article className='contact_option'>
